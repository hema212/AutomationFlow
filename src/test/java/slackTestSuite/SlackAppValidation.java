...
public class SlackAppValidation extends BaseDriver {
	...
	/*
	 * @Test(priority = 4) public void ValidateGiveRecogUsingShortcut() throws
	 ...
	 * slackappobject.sendButton().click(); }
	 * //slackappobject.continueWithoutAuthorizationButton().click();
	 * Thread.sleep(1000L); giveRecognitionFunc();
	 * 
	 * }
	 */
