...
public class SlackDeleteUsersInQueuedFlowTest extends InitiateDriver {
	...
	// validate Manage landing page when slack is not connected
		...
		public void validateCancelButtonOnClick() throws InterruptedException {
			...
			System.out.println("Is Connect Slack button Enabled in Connect page? " + slackobject.ConnectSlackButton().isEnabled());
	...
	/*
	 * @Test(priority = 2) public void connectSlackOnCancel() throws
	 ...
	 * 
	 * @Test(priority = 3) public void validateQueuedInvitesFlow() throws
	 * InterruptedException { slackIconPagevalidateOnClick();
	 ...
	 * 
	 * @Test(priority = 4) public void validateQueuedInvitesFlowOnView() throws
	...
	public void validateValidLogin() throws InterruptedException {
		...
		if (mainContent == null) {
			...
			System.out.println("Successfully logged into Assembly homepage!");
			Assert.assertEquals(mainContent, "Give Recognition");
			System.out.println("Assertion Passed for homepage landing");
		}
	}
